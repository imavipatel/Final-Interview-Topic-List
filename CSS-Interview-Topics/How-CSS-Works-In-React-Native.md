...
- React Native does NOT use browser CSS files. Instead it use JavaScript
...
# HOW LAYOUT IS DECIDED (YOGA flow) — simple steps

1. React Native builds a tree of components (View, Text, Image).
...
- Re-layout happens on prop/state changes, dimension/orientation change, or when parent/child styles change.
...
# WORKING EXAMPLE — copy into a screen file and run
...
# PERCENTAGES, INTRINSIC SIZE & STRETCH — short notes
