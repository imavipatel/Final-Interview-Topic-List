...
- A **Callback** is a function you passed as an argument to another function. so it can be called later.
...
# Mixing Callbacks with Microtasks/Macrotasks
...
# Callback Functions in JS ft. Event Listeners by Akshay Saini
