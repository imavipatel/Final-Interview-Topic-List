...
- Async/await is modern javascript syntax which makes working with Promises more readable and easier to understand.
- It allows you to write async code that looks and behaves more like synchronous code.

**async:**
Async Keyword placed before function declaration make a function always return a promise.

**await:**

Await keyword pauses execution until the promise settles (resloves or reject).

# Benefits of Async/Await?

- Readability
- Easy error handling by (try/catch)
- Easy to debug code
- Sequential flows -> dependent async operation
